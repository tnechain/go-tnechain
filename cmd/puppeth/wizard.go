...
type wizard struct {
	...
	services map[string][]string   // tnechain services known to be running on servers
...
// converts it to an tnechain address. If an empty line is entered, the default
// value is returned.
