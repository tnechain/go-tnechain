...
import (
	...
	"github.com/tnechain/go-tnechain/common/compiler"
)

var (
	abiFlag = flag.String("abi", "", "Path to the tnechain contract ABI json to bind")
	binFlag = flag.String("bin", "", "Path to the tnechain contract bytecode (generate deploy method)")
	typFlag = flag.String("type", "", "Struct name for the binding (default = package name)")

	solFlag  = flag.String("sol", "", "Path to the tnechain contract Solidity source to build and bind")
