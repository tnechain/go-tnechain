## Go tnechain Dashboard

The dashboard is a data visualizer integrated into gtst, intended to collect and visualize useful information of an tnechain node. It consists of two parts:
