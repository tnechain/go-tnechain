...
// Whisper represents a dark communication interface through the tnechain
...
// New creates a Whisper client ready to communicate through the tnechain P2P network.
